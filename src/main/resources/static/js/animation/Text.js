...
$.get("x-fragment/textFragment.fs", function(data) {
	fragmentShaderSrc = data;
	$.get("x-vertex/textVertex.vs", function(data) {
		vertexShaderSrc = data;
...
function init(font) {
	...
	var geometry = new THREE.TextGeometry('Jettours', {
		font : font,
		size : 50,
		height : 15,
		curveSegments : 10,
