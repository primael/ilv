...
THREE.Mirror = function(renderer, camera, options) {
	...
	var height = options.textureHeight !== undefined ? options.textureHeight
			: 512;

	this.clipBias = options.clipBias !== undefined ? options.clipBias : 0.0;

	var mirrorColor = options.color !== undefined ? new THREE.Color(
			options.color) : new THREE.Color(0x7F7F7F);
	...
	if (debugMode) {
		...
		var arrow = new THREE.ArrowHelper(new THREE.Vector3(0, 0, 1),
				new THREE.Vector3(0, 0, 0), 10, 0xffff80);
...
THREE.Mirror.prototype.renderWithMirror = function(otherMirror) {
	...
	// set the camera of the other mirror so the mirrored view is the reference
	// view
...
THREE.Mirror.prototype.updateTextureMatrix = function() {
	...
	this.textureMatrix.set(0.5, 0.0, 0.0, 0.5, 0.0, 0.5, 0.0, 0.5, 0.0, 0.0,
...
THREE.Mirror.prototype.renderTemp = function() {
	...
	if (scene !== undefined && scene instanceof THREE.Scene) {
		...
		this.renderer
				.render(scene, this.mirrorCamera, this.renderTarget2, true);
